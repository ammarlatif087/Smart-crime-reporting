...
class ColorManager {
  ...
  static Color primary = HexColor.fromHex('#2A2B7A');
  static Color secondary = HexColor.fromHex('#EB0E15');
  static Color primaryLight = HexColor.fromHex('#7CE97B');

  // static Color secondaryLight = HexColor.fromHex('#F9A84D');
  static Color green = HexColor.fromHex('#00B107');
  static Color textButton = HexColor.fromHex('#1877F2');
  static Color buttonRed = HexColor.fromHex('#FF4949');
  static Color orange = HexColor.fromHex('#FF8F25');
  static Color blue = HexColor.fromHex('#277EFF');
